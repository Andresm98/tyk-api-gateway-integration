...
public class mainTest {
    ...
    void createClientTest() {
        ...
        when(clientServiceMock.create(any(ClientDto.class))).thenReturn(newClient);
    ...
    // F5: Prueba Unitaria de la Entidad de Dominio
    @Test
    ...
    // F6: Prueba de Integración (End-to-End en el microservicio)
    @Test
    public void createClientAndGetById_ShouldReturnClient() {
        ...
        newClient.setAddress("Quito");
        newClient.setPhone("0999999999");
        ...
        assertThat(getResponse.getBody().getName()).isEqualTo("Test Integration");
    }
}
